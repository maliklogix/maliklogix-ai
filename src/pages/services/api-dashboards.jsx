...
import { 
  ...
  Target, Zap, LayoutDashboard, LineChart, PieChart, Activity, Shield, HardDrive
} from 'lucide-react';
...
export default function ApiDashboardsPage() {
    const content = pageContent['api-dashboards'];
    ...
    return (
        <div className="min-h-screen bg-background transition-colors duration-500 overflow-hidden relative text-foreground font-body">
            ...
            <main className="relative z-10 pt-32 pb-24">
                ...
                <section className="px-8 lg:px-20 py-20 max-w-7xl mx-auto">
                    <div className="max-w-4xl">
                        ...
                        >
                            ...
                            <span className="text-xs font-mono text-accent uppercase tracking-[0.3em] font-bold">Analytics · Real-time Intelligence</span>
                        </motion.div>
                        ...
                        >
                            <Link to="/contact" className="px-10 py-5 bg-accent text-white font-bold rounded-2xl flex items-center gap-3 hover:scale-105 transition-all shadow-xl shadow-accent/20 text-lg uppercase tracking-widest font-display">
                                Access Your Console <ArrowUpRight size={20} />
                            </Link>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="px-8 lg:px-20 py-24 border-y border-border/50 bg-card-bg/5 backdrop-blur-xl">
                    <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_450px] gap-20 items-center">
                        <div className="glass-card p-12 md:p-16 border-l-4 border-l-accent relative overflow-hidden group">
                            ...
                            <h2 className="text-3xl md:text-4xl font-display font-bold mb-8 italic">"Unified <span className="text-accent underline decoration-accent/20 underline-offset-8">Visibility</span> Across Every Department."</h2>
                            <div className="space-y-6 text-secondary text-lg leading-relaxed font-body">
                                <p>{content.whatItIs}</p>
                                <p>
                                    MalikLogix engineers custom dashboard architectures that pull live data from any REST API, GraphQL, or SQL database. We don't just show graphs; we define the KPIs that matter for your growth, ensuring your leadership team can make decisions based on truth, not intuition.
                                </p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { icon: <LineChart />, title: "Live Sync", desc: "Real-time API polling." },
                                { icon: <Activity />, title: "Health", desc: "System performance monitoring." },
                                { icon: <Shield />, title: "Secure", desc: "Enterprise-grade encryption." },
                                { icon: <HardDrive />, title: "Stored", desc: "Historical data warehousing." }
                            ].map((item, i) => (
                                <motion.div 
                                    key={i}
                ...
                {/* 3. The Analytics Protocol (Process) */}
                <section className="px-8 lg:px-20 py-32 max-w-7xl mx-auto">
                    <div className="text-center mb-24">
                        <h2 className="section-title mb-6 font-display uppercase tracking-widest">Engineering <span className="text-accent underline decoration-accent/10">Clarity</span></h2>
                        <p className="text-secondary max-w-xl mx-auto text-lg font-body">A data-integrity first approach to custom business intelligence.</p>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-16 text-center relative z-10">
                        {content.results.map((metric, i) => (
                            <div key={i} className="flex flex-col items-center p-8 border-r last:border-0 border-white/10 group">
                                <PieChart className="w-12 h-12 mb-8 opacity-40 group-hover:opacity-100 transition-opacity" />
                ...
                <section className="px-8 lg:px-20 py-32 border-b border-border/50">
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24">
                        <div className="space-y-16">
                            <div>
                                <h2 className="section-title !text-4xl text-left italic mb-8">Platform <span className="text-accent underline decoration-accent/20">Capabilities</span></h2>
                                <p className="text-secondary text-lg mb-12 font-body max-w-xl">
                                    Our dashboards are mobile-responsive and built on high-performance React frameworks to ensure your data is accessible anywhere, anytime.
                                </p>
                            </div>
                ...
                <section className="px-8 lg:px-20 py-24 text-center">
                    <div className="glass-card max-w-4xl mx-auto p-16 md:p-24 border-t-8 border-t-accent shadow-2xl relative overflow-hidden group">
                        ...
                        <h2 className="text-5xl md:text-7xl font-display font-bold mb-10 tracking-tighter">Your Business, <span className="text-accent italic">Visualized</span></h2>
                        <p className="text-xl text-secondary mb-12 max-w-xl mx-auto leading-relaxed font-body">
                            Stop guessing. Start knowing. Let's build a custom data cockpit that gives you total command over your operations.
                        </p>
                        <Link to="/contact" className="px-12 py-6 bg-accent text-white font-bold rounded-2xl text-xl hover:scale-105 transition-transform inline-flex items-center gap-4 shadow-2xl shadow-accent/20 font-display uppercase tracking-widest">
                            Engineer Your Dashboard <ArrowUpRight size={24} />
                        </Link>
                    </div>
                </section>
            </main>
