...
import { 
  ...
  Target, Zap, Search, Globe, Shield, Activity
} from 'lucide-react';
...
export default function SeoStrategyPage() {
    const content = pageContent['seo-strategy'];
            ...
            <main className="relative z-10 pt-32 pb-24">
                ...
                <section className="px-8 lg:px-20 py-20 max-w-7xl mx-auto">
                    <div className="max-w-4xl">
                        ...
                        >
                            ...
                            <span className="text-xs font-mono text-accent uppercase tracking-[0.3em] font-bold">Solutions · SEO Intelligence</span>
                        </motion.div>
                        ...
                        >
                            <Link to="/contact" className="px-10 py-5 bg-accent text-white font-bold rounded-2xl flex items-center gap-3 hover:scale-105 transition-all shadow-xl shadow-accent/20 text-lg">
                                Secure Your Audit <ArrowUpRight size={20} />
                            </Link>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="px-8 lg:px-20 py-24 border-y border-border/50">
                    <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_400px] gap-16 items-center">
                        <div className="glass-card p-12 md:p-16 border-l-4 border-l-accent">
                            <h2 className="text-3xl md:text-4xl font-display font-bold mb-8 italic">"Invisible errors <span className="text-accent underline decoration-accent/20 underline-offset-8">kill</span> growth."</h2>
                        ...
                        <div className="relative aspect-square flex items-center justify-center">
                            ...
                            <Search size={180} className="w-48 h-48 text-accent/20 relative z-10" />
                            <motion.div 
                ...
                <section className="px-8 lg:px-20 py-32 border-b border-border/50">
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
                        <div className="space-y-12">
                            <h2 className="section-title !text-4xl text-left italic">Strategy <span className="text-accent underline decoration-accent/20">Capabilities</span></h2>
                ...
                <section className="px-8 lg:px-20 py-24 text-center">
                    <div className="glass-card max-w-4xl mx-auto p-16 md:p-24 border-t-8 border-t-accent shadow-2xl relative overflow-hidden">
                        ...
                        <h2 className="text-4xl md:text-5xl font-display font-bold mb-8">Deploy Strategy <span className="text-accent">Now</span></h2>
