...
export default function FunnelAutomationPage() {
    const content = pageContent['funnel-automation'];
        ...
        <div className="min-h-screen bg-background transition-colors duration-500 overflow-hidden relative">
            ...
            <main className="relative z-10 pt-32 pb-24">
                ...
                <section className="px-8 lg:px-20 py-20 max-w-7xl mx-auto">
                    <div className="max-w-4xl">
                        ...
                        >
                            ...
                            <span className="text-xs font-mono text-accent uppercase tracking-[0.3em] font-bold">Solutions · Pipeline Design</span>
                        </motion.div>
                        ...
                        >
                            <Link to="/contact" className="px-10 py-5 bg-accent text-white font-bold rounded-2xl flex items-center gap-3 hover:scale-105 transition-all shadow-xl shadow-accent/20 text-lg">
                                Automate Your Sales <ArrowUpRight size={20} />
                            </Link>
                        </motion.div>
                    </div>
                </section>
                ...
                <section className="px-8 lg:px-20 py-24 border-y border-border/50">
                    <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_400px] gap-16 items-center">
                        <div className="glass-card p-12 md:p-16 border-l-4 border-l-accent">
                            <h2 className="text-3xl md:text-4xl font-display font-bold mb-8 italic">"A frictionless path, <span className="text-accent underline decoration-accent/20 underline-offset-8">zero</span> leakage."</h2>
                        ...
                        <div className="relative aspect-square flex items-center justify-center">
                            ...
                            <Workflow size={180} className="w-48 h-48 text-accent/20 relative z-10" />
                            <motion.div 
                ...
                <section className="px-8 lg:px-20 py-24 max-w-7xl mx-auto">
                    <h2 className="section-title mb-16">The Flow <span className="text-accent">Protocol</span></h2>
