...
export default function Blog() {
    ...
    const handlePageChange = (pageNumber) => {
        ...
        // Scroll to grid top with offset for navbar
        if (gridRef.current) {
                                ...
                                <div className="mt-20 flex flex-col items-center gap-6">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button 
                                            ...
                                            className="w-12 h-12 flex items-center justify-center rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] text-[var(--foreground)] hover:border-accent hover:text-accent disabled:opacity-30 disabled:hover:text-inherit disabled:hover:border-[var(--border)] transition-all"
                                        >
                                            <ChevronLeft size={20} />
                                        </button>
                                            ...
                                            {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                                                <button
                                                    ...
                                                    className={`w-12 h-12 rounded-2xl font-bold transition-all ${
                                                        ...
                                                        : 'border border-[var(--border)] bg-[var(--card-bg)] text-[var(--secondary)] hover:border-accent hover:text-accent'
                                                    }`}
                                                >
                                                    {page}
                                                </button>
                                    ...
                                    <p className="text-xs font-mono text-[var(--secondary)] uppercase tracking-[0.2em] opacity-40">
